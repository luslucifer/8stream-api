...
**Endpoint** - `/mediaInfo?id=tt1877830`
...
**Try** - [try](https://8-stream-api.vercel.app/mediaInfo?id=tt1877830)
...
**Endpoint** - `/getSeasonList?id=tt11737520`
...
**Try** -  [try](https://8-stream-api.vercel.app/getSeasonList?id=tt11737520)
...
**Example**
```bash
fetch('https://example.com/getStream',
